...
### Self Check
- Did you properly chain class selectors for each rule? --> yep
- Does the `proportioned` image retain its original square proportions? --> yep
- Does the `distorted` image end up looking squished and, well, distorted? --> yep
