...
### Self Check
- Does each element have a unique class name? --> yes. Could have been id's, but classes work just as well.
- Did you use the grouping selector for styles that both elements share? Yes. (even though I feel a seperate class would have worked as well.)
- Did you make separate rules for the styles unique to each element? Yes, just using the unique class names.
